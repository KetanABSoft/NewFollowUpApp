  ...
  Future login(String username, String password) async {
    ...
    if (jsondata['result'] == "failure") {
      ...
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => EmpDashboardScreen()));
    }
  }
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: const InputDecoration(
                                    ...
                                    // suffixIcon: obscurePasswords ? Icon(Icons.visibility_off):Icon(Icons.visibility)
                                  ),
                                  validator: (value) {
                                    if ( value!.isEmpty) {
                              ...
                              if(success)
                              {
                                ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text("login Succesfully "),
                                        ...
                                        margin: EdgeInsets.only(top: 16, left: 10, right: 10,bottom: 660),
                              ...
                              else
                              {
                                ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(content: Text("Usenname or password are incorrect"),
                                        ...
                                        margin: EdgeInsets.only(top: 16, left: 10, right: 10,bottom: 700),
                                        duration: Duration(seconds: 3)));
                              }
                            }
                        },
