...
import 'emp_edit_recorder_screen.dart';
import 'emp_total_task_list.dart';
import 'recorder_screen.dart';
import 'emp_task_completed_screen.dart';
import 'emp_task_recieve_screen.dart';
import 'emp_task_send_screen.dart';
...
class EmpEditTaskScreen extends StatefulWidget {
  final String task;
  final String id;
  ...
  @override
  State<EmpEditTaskScreen> createState() => _EmpEditTaskScreenState();
}

// class _EditState extends State<Edit> {
class _EmpEditTaskScreenState extends State<EmpEditTaskScreen> with WidgetsBindingObserver {
                        ...
                        task == 'all'
                            ...
                            : task == 'completed'
                                ? Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => EmpTaskCompletedScreen(), // Provide a default value if admintype is null
                                    ),
                                  )
                                : task == 'receive'
                                    ? Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => EmpReceiveTask(), // Provide a default value if admintype is null
                                        ),
                                      )
                                    : Navigator.push(
                                        context,
