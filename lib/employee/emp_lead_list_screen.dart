...
class EmpLeadList extends StatefulWidget {
  const EmpLeadList({Key? key}) : super(key: key);

  @override
  State<EmpLeadList> createState() => _EmpLeadListState();
}

class _EmpLeadListState extends State<EmpLeadList> {
  List<dynamic> leads = [];
