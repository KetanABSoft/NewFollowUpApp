...
class EmpTaskCompletedScreen extends StatefulWidget {
  const EmpTaskCompletedScreen({Key? key}) : super(key: key);
  @override
  State<EmpTaskCompletedScreen> createState() => _EmpTaskCompletedScreenState();
}
class _EmpTaskCompletedScreenState extends State<EmpTaskCompletedScreen> {
  @override
  void initState() {
    super.initState();
    //completeTaskApi();
