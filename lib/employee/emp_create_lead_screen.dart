...
import 'emp_lead_list_screen.dart';
import 'emp_dashboard_screen.dart';

class EmpCreateLead extends StatefulWidget {
  final String? id;
  final String? task;

  EmpCreateLead({required this.id, required this.task});

  @override
  State<EmpCreateLead> createState() => _EmpCreateLeadState();
}

File? _selectedImage = null;
final picker = ImagePicker();

class _EmpCreateLeadState extends State<EmpCreateLead> {
  ...
  void updatelead(customer_name, company_name, contact_no, mail_id, website,
    ...
    if (jsondata['result'] == "sucess") {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => EmpLeadList()),
      );
    }
  }
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => EmpDashboardScreen(),));
            },
          ),
        ),
                                      ...
                                      if(success)
                                        {
                                          ...
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => EmpLeadList(),));
                                        }
                                      else
                                        {
                                          ScaffoldMessenger.of(context).showSnackBar(
