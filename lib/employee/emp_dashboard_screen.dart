...
import 'emp_add_task_screen.dart';
import 'emp_total_task_list.dart';
import 'notifications_screen.dart';
import 'emp_overdue_task.dart';
...
import 'emp_task_pending_screen.dart';
import 'emp_create_lead_screen.dart';
...
class _EmpDashboardScreenState extends State<EmpDashboardScreen>
  ...
  void _handleDashboard(BuildContext context) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => EmpDashboardScreen(),
      ),
    );
  }
  ...
  void _handleAddLead(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => EmpCreateLead(id: '0', task: '')),
    );
  }
  ...
  void handleoverduetask() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EmpOverdueTask(admin_type: admintype.toString()),
      ),
    );
  }
  ...
  void _handleCard2Tap() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EmpTaskCompletedScreen(),
      ),
   );
  }
  ...
  void _handleCard3Tap() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => EmpReceiveTask(),
      ),
   );
  }
