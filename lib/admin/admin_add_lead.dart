...
class AdminAddLead extends StatefulWidget {
  final String? id;
  final String? task;

  AdminAddLead({required this.id, required this.task});

  @override
  State<AdminAddLead> createState() => _AdminAddLeadState();
}

File? _selectedImage = null;
final picker = ImagePicker();

class _AdminAddLeadState extends State<AdminAddLead> {
            ...
            child: AppBar(
              ...
              title: Text(
                ...
                style: TextStyle(
                  fontFamily: 'Poppins',
                  color:
                  Colors.white, // Set app bar text color to white
                  fontSize: 20,
